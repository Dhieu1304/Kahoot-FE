...
function Home() {
    ...
    const render = () => {
        if (isLoading) return (<p className="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">...Loading!</p>)
        ...
        return (
            <>
                {user ?
                    ...
                    :
                    <>
                        <p className="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Welcome to my app!</p>
